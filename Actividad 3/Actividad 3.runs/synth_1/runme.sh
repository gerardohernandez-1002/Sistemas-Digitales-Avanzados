...
HD_PWD='C:/Users/gerco/Downloads/Ger/Sistemas Digitales/Actividad 3/Actividad 3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador_fp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador_fp.tcl
