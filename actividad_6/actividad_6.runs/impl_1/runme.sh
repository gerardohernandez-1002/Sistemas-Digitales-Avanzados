...
HD_PWD='C:/Users/gerco/Downloads/Ger/Sistemas Digitales/actividad_6/actividad_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_top_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gcd_top_8bit.tcl -notrace
