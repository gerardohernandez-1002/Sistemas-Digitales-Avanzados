...
HD_PWD='C:/Users/gerco/Downloads/Ger/Sistemas Digitales/actividad_6/actividad_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_top_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcd_top_8bit.tcl
