...
HD_PWD='C:/Users/gerco/Downloads/Ger/Sistemas Digitales/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log door_lock_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source door_lock_top.tcl
