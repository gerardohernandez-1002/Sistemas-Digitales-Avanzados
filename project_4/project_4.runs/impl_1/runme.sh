...
HD_PWD='C:/Users/gerco/Downloads/Ger/Sistemas Digitales/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log door_lock_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source door_lock_top.tcl -notrace
